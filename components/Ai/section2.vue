  ...
  <section class="bg-white dark:bg-black">
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
        <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Work with Data and AI</h2>
      </div>
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
        <div>
          ...
          <h3 class="mb-2 text-xl font-bold dark:text-white">DATA SERVICES</h3>
        ...
        <div>
          ...
          <h3 class="mb-2 text-xl font-bold dark:text-white">RESPONSIBLE AI</h3>
        ...
        <div>
          ...
          <h3 class="mb-2 text-xl font-bold dark:text-white">GENERATIVE AI</h3>
        ...
        <div>
          ...
          <h3 class="mb-2 text-xl font-bold dark:text-white">AI TALENT AND WORKFORCE</h3>
        ...
        <div>
          ...
          <h3 class="mb-2 text-xl font-bold dark:text-white">AI REFINERY</h3>
