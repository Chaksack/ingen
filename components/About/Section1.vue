<template>
  <section class="">
    <div class="gap-4 items-center  py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2">
      <div class="py-2 px-4 mx-auto max-w-screen-xl">
        <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-2 md:gap-12 md:space-y-0">
          ...
          <div class=" bg-gradient-to-r from-syentiaGreen via-syentiaGreen to-syentiaBlue rounded-lg p-4 shadow-2xl">
            <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
            ...
            <p class="">Protect your organization, devices and stay compliant with our structured workflows and custom permissions made for you.</p>
          </div>
          <div class=" bg-gradient-to-r from-syentiaGreen via-syentiaGreen to-syentiaBlue rounded-lg p-4 shadow-2xl">
            <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
            ...
            <p class="">Auto-assign tasks, send Slack messages, and much more. Now power up with hundreds of new templates to help you get started.</p>
          </div>
          <div class="bg-gray-800 rounded-lg p-4 shadow-2xl">
            <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
      ...
      <div class="mt-42md:mt-0">
        <img class="w-78 hidden dark:block" src="../../assets/checklist-pana.png" alt="dashboard image">
      </div>
    </div>
  </section>
</template>
